...
function RadiusCalc() {
	...
	if (a){
		localStorage.setItem("Rectangle", false);
		...
		localStorage.setItem("Rectangle", true);
		window.side1 = parseFloat(document.getElementById("SideValue").value);
	...
	document.getElementById("ShapeUnits").removeAttribute("hidden");
...
function ChangeShapeUnits() {
	...
	if (localStorage.getItem("english") === "true") {		
		if (localStorage.getItem("Rectangle") === "true") {
debugger;
			if (ShapeUnits == "ft") {
